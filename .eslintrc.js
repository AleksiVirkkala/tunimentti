module.exports = {
  ...
  rules: {
    ...
    'vue/no-unregistered-components' : ['error', { ignorePatterns: ['v-*', 'page-*', 'base-*']}], // Verifies that used components are registered and ignore all that start with v- and own global components
